...
export default function FeatureSection({ data }: FeatureSectionProps) {
  if (data?.type != 'small') {
    return (
      <Container className={'text-center min-h-[257px] my-20 py-10  text-[#140D31] relative'}>
        {data.title?.en && (
          <>
...
const SmallFeature = ({ data }: FeatureProps) => {
  return (
    <div className="m-auto  text-center flex  items-center justify-start w-full ">
