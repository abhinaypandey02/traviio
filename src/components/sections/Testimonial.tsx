  ...
  return (
    <div className={varient == 1 ? 'w-full' : 'w-full rounded-2xl  border-gray  px-5 py-2 shadow-xl'}>
      ...
      <div className='flex gap-x-3 my-4'>
        <div>
          <img src={'https://media.istockphoto.com/id/1349796126/photo/flag-of-india.webp?b=1&s=170667a&w=0&k=20&c=1pWIs3VkXqu1wNBGcztG5IixaN4oGA-nul4Ynb1G2QY='}
            alt="" className='rounded-full w-12 h-12' />
        </div>
        <div className='ml-2 '>
...
const Testimonial = (props: TestimonialSectionProps) => {
  ...
  const { data: { title, subtitle, image, testimonials } } = props;
  ...
  return (
    <div className='w-full bg-[#F2FAFF]  text-black px-10 py-10 lg:flex items-center gap-x-10 bg-primary'>
      <div className='lg:w-1/5 w-full'>
        ...
        <Image src={image ? urlFor(image) : ''}
          width={260} height={73} alt="" style={{ borderRadius: "10px" }} />
      </div>
