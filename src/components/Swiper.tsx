    ...
    <div className={'relative overflow-hidden'}>
      ...
      <div className={'flex  justify-end gap-5 mt-8'}>
        {showPrev && (
          <div
            className={
              'rounded-full  z-[1000] bg-blue h-10 flex items-center justify-center w-10 md:absolute right-20 -bottom-20  md:right-0 md:left-4 md:top-1/2 -translate-y-1/2 cursor-pointer '
            }
            onClick={onPrev}
          >
            <svg
        ...
        {showNext && (
          <div
            className={
              'rounded-full bg-blue  h-10 z-[600] flex items-center justify-center w-10 md:absolute right-4 -bottom-20 md:top-1/2 -translate-y-1/2 cursor-pointer'
            }
            onClick={onNext}
          >
            <svg
