  ...
  return (
    <div className="rounded-2xl w-[300px]">
      ...
      <div className="bg-[#e7f5fd] px-4 py-4 rounded-b-2xl">
        <form>
          <div className="my-3">
            <label className="text-lg my-1" htmlFor="name">
              Name*
            </label>
          ...
          <div className=" my-3">
            <label className="text-lg my-1" htmlFor="email">
              Email*
            </label>
          ...
          <div className="my-3">
            <label className="text-lg   my-1" htmlFor="nationality">
              Nationality*
            </label>
          ...
          <div className=" my-3">
            <label className="text-lg my-1" htmlFor="mobile">
              Mobile
            </label>
            <input type="email" className="w-full my-1 rounded-md h-10" />
          </div>
          ...
          <div className=" my-3">
            <label className="text-lg my-1" htmlFor="details">
              More Deatils
            </label>
